...
def create_apparelo_process(from_process=None,to_process=None):
	...
	processes={'Knitting':['Roll','Roll'],'Dyeing':['Roll','Roll'],'Bleaching':['Roll','Roll'],'Compacting':['Roll','Roll'],'Steaming':['Roll','Roll'],'Roll Printing':['Roll','Roll'],'Cutting':['Roll','Kg'],'Piece Printing':['Kg','Kg'],'Label Fusing':['Kg','Kg'],'Stitching':['Kg','Kg'],'Checking':['Kg','Kg'],'Ironing':['Kg','Kg'],'Packing':['','']}
